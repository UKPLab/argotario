...
function($rootScope, $ionicBody, $compile, $timeout, $ionicPlatform, $ionicTemplateLoader, $q, $log) {
    ...
    // Injection of used methods, copied from https://github.com/driftyco/ionic/blob/01c829c35114a655e50e98d46e3b03f72364c13f/js/angular/main.js
    ...
    */
    ...
    var createModal = function(templateString, options) {
        ...
        //Raffael
        var wrapper = '<div class="custom-modal '+options.viewType+'">' + templateString + '</div>';
        // Compile the template
        var element = $compile('<ion-' + options.viewType + '>' + wrapper + '</ion-' + options.viewType + '>')(scope);
